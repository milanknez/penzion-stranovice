            ...
            <div class="about-grid">
                ...
                <div class="reveal" style="display: flex; flex-direction: column; justify-content: space-between; height: 100%;">
                    <div>
                        ...
                        <p>Tento prostorný apartmá je pro 3 osoby. Disponuje jednou ložnicí, velkou koupelnou se sprchou i vanou a malou lednicí s mrazáčkem. K dispozici je také TV s plochou obrazovkou a bezplatné Wi-Fi připojení. K ubytování je možnost objednat si snídani.</p>
                    ...
                    <div style="margin-top: auto; padding-top: 1.5rem;">
                        ...
                        <div style="font-size: 0.85rem; color: var(--text-muted); margin-bottom: 1.5rem; font-style: italic;">
                            * Při rezervaci pouze na 1 noc +300 Kč servisní poplatek k ceně.
                        </div>
                        <div style="display: flex; gap: 1rem; flex-wrap: wrap; align-items: center;">
                            ...
                            <button type="button" class="btn btn-outline-primary open-room-calendar" data-room="kvetinovy" data-room-name="Květinový apartmán">
